...
// //       {/* --- SHARED STYLES --- */}
// //       <style jsx global>{`
// //         /* Desktop Containment - Yeh content ko "Simta Hua" banata hai */
// //         @media (min-width: 1200px) {
// //             .container {
// //                 max-width: 1040px !important; /* Isse screen ke sides pe space ban jayegi */
...
// //         .about-content-row-custom {
// //             margin-top: 80px; /* Thoda gap kam kiya prototype jesa karne ke liye */
// //         }
...
// //         .main-description-text {
// //             font-size: 16px !important; /* Thoda bara kiya readability ke liye */
// //             line-height: 1.7;
// //             text-align: justify;
// //             color: #333;
// //         }
...
// //             .container {
// //                 max-width: 100% !important;
// //                 padding-left: 20px !important; /* Mobile pe 80px zyada tha, 20px perfect hai */
// //                 padding-right: 20px !important;
// //             }
...
//       {/* --- SECTION 2: CONTENT AREA --- */}
//       <div className="rts-about-area rts-section-gap">
//         <div className="container custom-container-width pt--40 main-content-overlap">
...
//       <style jsx global>{`
//         /* Desktop Center Alignment Strategy */
//         @media (min-width: 1200px) {
...
//         /* --- MOBILE RESPONSIVE STYLING (Intact as per your request) --- */
//         @media (max-width: 768px) {
//             .rts-breadcrumb-area.top-300 {
//                 padding-top: 30px !important;
//                 padding-bottom: 5px !important;
...
//             .container {
//                 padding-left: 20px !important; /* Adjusted for better balance on mobile */
//                 padding-right: 20px !important;
//             }
...
const GujranwalaAbout = () => {
  ...
  return (
    <>
      ...
      `}</style>
      <style jsx global>{`
  /* --- SIRF MOBILE VIEW FIXES --- */
  @media (max-width: 768px) {
      /* 1. Text ke darmiyan ke ajeeb gaps khatam karne ke liye */
      .main-description-text, 
      .chairman-description, 
      .disc {
          text-align: left !important; /* Justify khatam karke gaps fix kiye */
          word-spacing: -1px !important; /* Words ko qareeb lane ke liye */
          line-height: 1.5 !important; 
          margin-bottom: 15px !important;
          letter-spacing: -0.2px !important;
      }

      /* 2. Screen ke edges (sides) se chipakne ko fix karein */
      .main-content-overlap, 
      .custom-container-width {
          padding-left: 20px !important;
          padding-right: 20px !important;
          margin-top: 10px !important; /* Top extra space khatam */
      }

      /* 3. Heading aur Image ke darmiyan ka gap kam karein */
      .about-heading-container {
      ...
      /* 5. Paragraphs ke darmiyan double spacing khatam karein */
      br {
          display: block;
          content: "";
          margin-top: 5px;
