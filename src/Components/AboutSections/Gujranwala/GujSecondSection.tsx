    ...
    return (
        <>
            <style jsx global>{`
                ...
                /* --- DESKTOP SPECIFIC: Gap kam karne ke liye --- */
                @media (min-width: 992px) {
                    .desktop-narrow-row {
                        max-width: 1000px; /* Isse columns center mein mazeed kareeb aa jayenge */
                        margin: 0 auto !important;
                    }
                    .industry-list {
                        margin-left: 20px; /* Items ko thoda andar karne ke liye */
                    }
                }

                /* --- MOBILE SPECIFIC: Ye wahi hai jo aapne di thi (No changes) --- */
                @media (max-width: 991px) {
                    .working-process-area-three {
                        margin-left: 10px !important;
                        margin-right: 10px !important;
            ...
            >
                <div className="container mx-auto px-4">
                    ...
                    {/* Industry List Columns with Narrow Desktop Row */}
                    <div className="row justify-content-center mt-5 pt-10 desktop-narrow-row">
                        {industryColumns.map((column, colIndex) => (
                            <div 
                                key={colIndex} 
                                className="col-lg-4 col-md-6 mb-4" 
