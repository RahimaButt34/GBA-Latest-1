...
//                                     <p style={{ fontWeight: '900', color: 'black', fontSize: '16px', marginTop: '10px' }}>
//                                         Building Global Pathways For Gujranwala’s Industrial Growth
//                                     </p>
//                                 </div>
//                                 <p className="disc focus-description-text" style={{ textAlign: 'justify', marginTop: '20px' }}>
...
const OurFocusSection: React.FC = () => {
        ...
        <>
            ...
            <div className="rts-breadcrumb-area top-300">
                <div className="box-view-container"> {/* Container replaced with box-view-container */}
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="title-area-left" style={{ textAlign: 'left', position: 'relative' }}>
                                <span className="bg-title watermark-focus">Our Focus</span>
                            </div>
                        </div>
                    </div>
            ...
            {/* --- SECTION 2: MAIN CONTENT --- */}
            <div className="rts-about-area focus-section-main">
                <div className="box-view-container focus-main-overlap"> {/* Container replaced with box-view-container */}
            ...
            <style jsx global>{`
                ...
                .box-view-container {
                    ...
                    width: 100%;
                    // padding: 0 15px;
                    padding: 0 20px !important; /* Content ko side se gap dene ke liye */
                }
                ...
                .watermark-focus {
                    ...
                    opacity: 0.5;
                    position: absolute;
                    top: -100px; /* Fixed for Desktop Box View */
                    left: 0;
                    z-index: 0;
                }
                ...
                .focus-main-overlap {
                    margin-top: -100px !important; /* Adjusted for Desktop Alignment */
                    position: relative;
                }
                ...
                /* --- MOBILE (RE-APPLIED YOUR ORIGINAL STYLING - UNTOUCHED) --- */
                @media (max-width: 768px) {
                    .box-view-container {
                    ...
                    .focus-heading-container { margin-top: 0 !important; }
                    .focus-content-row { margin-top: 30px !important; }
                    .watermark-focus { font-size: 60px !important; top: -20px !important; }//top 40 updated
                    .pl--30 { padding-left: 15px !important; }
                    
                    .rts-breadcrumb-area.top-300 {
                        padding-top: 50px !important;//10
                        padding-bottom: 10px !important;
                        height: auto !important;
                    }
                    
                    /* Original sub-label logic for mobile */
                    .focus-sub-label {
                        margin-top: 20px !important;
                        top: 0;
                    }
                    ...
                    @media (max-width: 768px) {
  /* Watermark ko chhota aur upar set karein */
  .watermark-focus {
    font-size: 50px !important; 
    top: -10px !important; 
  ...
  /* Title aur main content ke darmiyan gap */
  .focus-heading-container {
    margin-top: 40px !important;
    margin-bottom: 20px !important;
  }

  /* Promotion heading ka size chhota karein */
  .promotion-title {
    font-size: 28px !important;
    line-height: 1.2 !important;
  }

  /* Description text (Image 3 aur 4 ka issue) */
  .focus-description-text {
    text-align: left !important; /* Mobile par justify gaps paida karta hai */
    font-size: 14px !important;
    line-height: 1.6 !important;
