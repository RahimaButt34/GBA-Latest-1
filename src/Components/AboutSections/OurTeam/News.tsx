...
const NewsletterCTA: React.FC = () => {
  ...
  return (
    <div className="rts-cts-area-start bg_cts-10 bg_iamge ptb--95 mt--160 newsletter-cta">
      ...
      <style jsx global>{`
        ...
        .newsletter-cta .cta-style-10-wrapper{
          display: flex;
          align-items: center;
          justify-content: space-between;
          gap: 40px;
        ...
        .newsletter-cta .left-side .title{
          font-size: 48px;
          font-weight: 700;
          line-height: 1.15;
          margin: 0;
        ...
        .newsletter-cta .right-side form{
          display: flex;
          align-items: center;
          gap: 12px;
        }

        .newsletter-cta .right-side input{
          height: 56px;
          padding: 0 18px;
          border-radius: 6px;
        ...
        .newsletter-cta .right-side input::placeholder{
          color: rgba(255,255,255,0.7);
        }

        .newsletter-cta .right-side button{
          height: 56px;
          padding: 0 28px;
          white-space: nowrap;
        }
