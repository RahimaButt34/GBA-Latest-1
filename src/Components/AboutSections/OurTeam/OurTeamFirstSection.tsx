...
//           {/* Added align-items-start to match Pic 2 alignment */}
//           {/* <div className="row about-content-row d-flex align-items-start">
...
//                   height={650}
//                   style={{ 
//                     objectFit: 'contain', // Corner cut nahi honge
//                     width: '100%', 
//                     height: 'auto', 
//                     borderRadius: '10px',
//                     display: 'block'
...
//             {/* TEXT COLUMN */}
//             {/* <div className="col-lg-7 pl--100 pl_md--0 mt_md--50 pl_sm--0 mt_sm--50">
//               <div className="about-content-right-three">
//                 <div className="title-style-three left">
//                   <h2 className="chairman-name-title" style={{ fontWeight: '800', marginBottom: '20px', marginTop: '0' }}>
//                     Ahmad Ikram Lone
//                   </h2>
//                 </div>
                
//                 <div className="description-container">
//                   <p className="disc main-description-text" style={{ textAlign: 'justify', marginTop: '0' }}>
//                     It is with great pride and enthusiasm that I extend my warmest greetings as Founder & Chairman of
//                     the Gujranwala Business Alliance (GBA). I am honoured to lead this alliance, dedicated to
//                     advancing Gujranwala's industrial potential and connecting our enterprises with global
//                     opportunities. 
//                     <br /><br />
//                     Renowned for its entrepreneurial spirit, craftsmanship, and industrial excellence, Gujranwala continues to be a symbol of resilience and innovation. Through GBA, we are building on these strengths to create a modern business ecosystem that fosters innovation, competitiveness, and collaboration. Our mission is to help local enterprises grow beyond borders and access new markets.
//                     <br /><br />
//                     I extend my sincere appreciation to our members, partners, and stakeholders for their trust. Together, we are shaping a stronger, more connected, and future-ready Gujranwala - a city standing proudly at the forefront of Pakistan's industrial and economic growth.
//                   </p>
//                 </div>
//               </div>
//             </div> */}
...
//         /* Image Wrapper modified to prevent corner clipping */
//         .chairman-image-wrapper {
//             width: 100%;
//             border-radius: 10px;
...
//     width: 100%;
//     border-radius: 10px;
//     overflow: hidden !important; /* Isse corners rounded aur clean dikhenge */
//     display: flex;
// }
//      .chairman-name-text {
//           font-size: 40px !important;
...
//         /* --- MOBILE RESPONSIVE --- */
//         @media (max-width: 991px) {
//             .pl--100 { padding-left: 0 !important; }
//             .about-content-row { margin-top: 50px; }
//             .chairman-name-title { margin-top: 30px; }
//         }
