...
// //               <div className="title-area-left center mt-dec-blog-bread">
// //                 <span className="bg-title">News</span>
// //                 <h1 className="title rts-text-anime-style-1"  style={{fontSize:'48px'}}>Latest Updates</h1>
// //                 <p className="disc">GBC official announcements & activities</p>
// //               </div>
// //             </div>
// //           </div>
...
//       {/* 🔹 BREADCRUMB AREA */}
//       <div className="rts-breadcrumb-area">
//         <div className="box-view-container"> {/* Applied Box View */}
//           <div className="row">
//             <div className="col-lg-12">
//               <div className="title-area-left center mt-dec-blog-bread">
//                 <span className="bg-title">News</span>
...
const BlogArchiveContent = () => {
  ...
  return (
    <>
      {/* 🔹 BREADCRUMB AREA */}
      <div className="rts-breadcrumb-area blog-breadcrumb-top">
      ...
      <div className="rts-blog-list-area rts-section-gapBottom mt-dec-blog-list">
        <div className="box-view-container"> 
          <div className="row g-5">
            <div className="col-xl-8 col-md-12 col-sm-12 col-12 blog-posts-wrapper">
              {currentDisplayedPosts.map((item, i) => {
                const postLink = `/blog-details/${makeSlug(item?.title || "")}`;
                return (
                  <div key={i} className="blog-single-post-listing">
      ...
      <style jsx global>{`
        ...
        /* --- MOBILE BREADCRUMB & BOX VIEW ADJUSTMENTS --- */
        @media (max-width: 991px) {
          .blog-breadcrumb-top {
          ...
          .mt-dec-blog-list {
              margin-top: 10px !important; /* Reduced margin to bring content up */
          }
          .mt-dec-blog-bread {
        ...
        @media (max-width: 768px) {
            .blog-breadcrumb-top {
                padding-top: 60px !important; /* Brings title further up on mobile */
            }
            .title-area-left h1.title {
                font-size: 28px !important; /* Smaller title for mobile space */
                margin-bottom: 10px;
            }
            .bg-title {
                font-size: 14px;
      ...
      <style jsx global>{`
  @media (max-width: 768px) {
    /* 1. Breadcrumb (Top Heading Section) ka bottom gap khatam karne ke liye */
    .rts-breadcrumb-area.blog-breadcrumb-top {
       // padding-top: -80px !important;
        margin-top: -80px !important;
    }

    /* 2. Blog List Area ko upar khinchne ke liye */
    .rts-blog-list-area.mt-dec-blog-list {
        margin-top: -40px !important; /* Isse list heading ke mazeed kareeb ho jayegi */
        padding-top: 0px !important;
    }

    /* 3. Section ke andar default padding ko kam karein */
    .rts-section-gapBottom {
        padding-top: 0px !important;
    }

    /* 4. Title area ki bottom spacing kam karein */
    .title-area-left.center {
        margin-bottom: 0px !important;
    }

    /* 5. Description (GBC official...) ke niche ka gap */
    .title-area-left .disc {
