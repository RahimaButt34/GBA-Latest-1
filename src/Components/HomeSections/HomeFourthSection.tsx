    ...
    return (
        <div className="rts-blog-area rts-section-gapTop">
            <div className="container pt--40">
                            ...
                            return (
                                <SwiperSlide key={post.id}>
                                    <div className="rts-blog-h-2-wrapper" style={{ margin: '15px 5px' }}>
                                        ...
                                        <div className="body">
                                            {/* Category styled in Black with suffix */}
                                            <span className="category-tag">
                                                {post.category} / by GBA Official
                                            </span>
                                            <h4 className="title">
                ...
                {/* Pagination Dots centered directly after the Swiper divs */}
            ...
            <style jsx global>{`
                ...
                /* Read More Layout: Arrow then Text */
                .rts-read-more {
                    display: flex;
                    align-items: center;
                    text-decoration: none !important;
                ...
                .rts-read-more:hover i { color: white; }
