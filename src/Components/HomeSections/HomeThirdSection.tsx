...
// //         /* Container ko prototype (Pic 2) ki alignment dene ke liye */
// //         .client-three-wrapper {
// //           display: flex;
// //           justify-content: center; 
// //           align-items: center;
// //           flex-wrap: nowrap;        
// //           gap: 25px;                /* Logos ke darmiyan balance gap */
// //           width: 100%;
// //           max-width: 1200px;        /* Center alignment ke liye max-width */
// //           margin: 0 auto;
// //         }

// //         /* Shape wahi rakhi hai (Rectangular box) jo pehle thi */
// //         .single {
// //           flex: 1;                  /* Saare boxes barabar width ke honge */
// //           display: flex;
// //           justify-content: center;
// //           align-items: center;
// //           background: #ffffff;      
// //           padding: 20px 30px;       /* Padding ko adjust kiya taake shape clean lage */
// //           border-radius: 8px;       
// //           box-shadow: 0 4px 15px rgba(0,0,0,0.05); 
// //           transition: all 0.3s ease;
// //           min-height: 90px;         /* Uniform height alignment ke liye */
// //         }

// //         .single img {
// //           max-width: 130px;         /* Logo size prototype ke mutabiq optimized */
// //           height: auto;
// //           display: block;
// //           transition: transform 0.3s ease;
// //         }
...
//         /* Prototype alignment: Centralized wrapper with proper spacing */
//         .client-three-wrapper {
//           display: flex;
//           justify-content: center; 
//           align-items: center;
//           flex-wrap: nowrap;        
//           gap: 20px;                /* Prototype ke mutabiq gap */
//           width: 100%;
//           margin: 0 auto;
//         }

//         /* Logo box styling to match Image_9d8670.png */
//         .single-logo-box {
//           flex: 1;                  /* Boxes ko barabar jagah dene ke liye */
//           max-width: 180px;         /* Box ki width thodi barhayi prototype ke liye */
...
//           padding: 10px 20px;       
//           border-radius: 6px;       
//           box-shadow: 0 5px 15px rgba(0,0,0,0.03); /* Soft shadow like prototype */
//           transition: all 0.3s ease;
//         }
...
//         .single-logo-box img {
//           max-width: 100%;
//           max-height: 45px;         /* Logo height control taake box se bahar na nikalay */
//           object-fit: contain;
//           filter: grayscale(1);      /* Agar logos colored hain to prototype jaisa look dene ke liye */
//           opacity: 0.7;
//           transition: 0.3s;
//         }
...
//               <div className="client-three-wrapper">
//                 {brandLogos.map((src, index) => (
//                   <div key={index} className="single-logo-box">
//                     <img 
//                       src={src} 
//                       alt={`Client Logo ${index + 1}`} 
//                     />
