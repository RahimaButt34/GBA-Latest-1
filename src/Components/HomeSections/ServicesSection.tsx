...
// //       const currentSlide = Math.min(swiper.realIndex + slidesPerView, totalSlides);
// //       const format = (n) => n.toString().padStart(2, '0');

// //       return `
// //         <span class="swiper-pagination-current">${format(currentSlide)}</span>
// //         /
// //         <span class="swiper-pagination-total">${format(totalSlides)}</span>
// //       `;
// //     },
// //   }}
// //   spaceBetween={30}
...
//         }
//         .swiper-button-prev-custom:hover,
//         .swiper-button-next-custom:hover { background: #0d1c2e; color: #ffffff; }
//         .swiper-pagination-fraction-custom {
//           font-size: 20px;
//           font-weight: 500;
//           color: #0d1c2e;
...
//           gap: 5px;
//         }
//         .swiper-pagination-fraction-custom .swiper-pagination-current { font-weight: 800; color: #0d1c2e; }
//         .swiper-pagination-fraction-custom .swiper-pagination-total { color: #6d767e; font-weight: 400; }
//         .swiper-button-next:after, .swiper-button-prev:after { display: none !important; }

//         @media (max-width: 768px) {
//           .bg-title.watermark-service { font-size: 80px !important; top: 5px !important; opacity: 0.8; }
//           .title-style-three .title { font-size: 28px !important; }
//           .title-style-three .pre { font-size: 13px !important; margin-bottom: 5px; }
//           .container-1680.mt--40 { margin-top: 20px !important; }
//           .swiper-controls-container { margin-top: 5px !important; gap: 10px; }
  ...
  return (
    <>
      ...
      <style jsx global>{`
        ...
        .title-style-three .title { font-size: 60px; font-weight: 900; text-transform: uppercase; display: inline-block; margin: 0; }
        .title-style-three .solid-text { color: #0d1c2e; }
        .title-style-three .outline-text { color: transparent; -webkit-text-stroke: 1.5px #0d1c2e; text-stroke: 1.5px #0d1c2e; margin-left: 10px; }
        .title-style-three .pre { display: block; font-size: 14px; letter-spacing: 2px; color: #666; margin-bottom: 10px; }
        .title-style-three.center { text-align: center; }

        .swiper-controls-container { display: flex; align-items: center; justify-content: center; gap: 30px; margin-top: 50px; }
        .swiper-button-prev-custom, .swiper-button-next-custom { width: 50px; height: 50px; background: #ffffff; display: flex; align-items: center; justify-content: center; border-radius: 8px; cursor: pointer; box-shadow: 0 4px 15px rgba(0,0,0,0.08); transition: 0.3s; color: #0d1c2e; font-size: 18px; border: none; z-index: 10; }
        .swiper-button-prev-custom:hover, .swiper-button-next-custom:hover { background: #0d1c2e; color: #ffffff; }
        .swiper-pagination-fraction-custom { font-size: 20px; font-weight: 500; color: #0d1c2e; width: auto !important; position: relative !important; display: flex; gap: 5px; }
        .swiper-pagination-fraction-custom .swiper-pagination-current { font-weight: 800; color: #0d1c2e; }
        .swiper-pagination-fraction-custom .swiper-pagination-total { color: #6d767e; font-weight: 400; }
        .swiper-button-next:after, .swiper-button-prev:after { display: none !important; }
        ...
        @media (max-width: 768px) {
          ...
          .container-1680.mt--40 { margin-top: 20px !important; }
          .swiper-controls-container { margin-top: 5px !important; gap: 10px; }
          .swiper-button-prev-custom, .swiper-button-next-custom { width: 42px; height: 42px; font-size: 14px; }
          .swiper-pagination-fraction-custom { font-size: 15px; }
        }
