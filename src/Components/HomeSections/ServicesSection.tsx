...
// // Autoplay module ko import kiya
// import { Swiper, SwiperSlide } from 'swiper/react';
...
//         {/* container-1680 ko container class di taake side margins mil jayein */}
...
//                     576: { slidesPerView: 2 },
//                     992: { slidesPerView: 3 },
//                     1600: { slidesPerView: 3 }, // 4 ki jagah 3 kiya taake margin clear dikhe
//                   }}
//                   className="mySwiper-case-studies-5"
//                 >
//                   {services.map((item, index) => (
  ...
  return (
    <>
      <div className="rts-section-gap">
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <div className="title-style-three center" style={{ position: 'relative' }}>
                <span className="pre" style={{ position: 'relative', zIndex: '2',fontSize:'16px' }}>Shaping a Global Future</span>
                <div className="bg-title watermark-service">03</div>
                <h2 className="title" style={{ position: 'relative', zIndex: '2' }}>
                  <span className="solid-text">OUR</span>
                  <span className="outline-text">SERVICES</span>
            ...
            <div className="col-lg-12">
              <div className="case-studies-wrapper-main-5">
                <Swiper
                  ...
                  autoplay={{
                    delay: 3500, // Thora zyada delay taake log parh sakein
                    disableOnInteraction: false,
                  }}
                  speed={1000} // Animation ki speed (1 second) taake smooth slide ho
                  grabCursor={true} // Mouse se drag karne ka feel acha aega
                  onSlideChange={(swiper) => setActiveSlide(swiper.realIndex + 1)}
                  navigation={{
                    prevEl: '.swiper-button-prev-custom',
                    nextEl: '.swiper-button-next-custom',
                ...
                >
                  {services.map((item, index) => (
                    <SwiperSlide key={index}>
                      <div className="single-case-studies-four custom-slide-animation">
                        <Link href={item.link} className="thumbnail overflow-hidden">
                          <Image
                            src={item.img}
                            alt={item.title}
                            width={400}
      ...
      <style jsx global>{`
        ...
        .custom-slide-animation:hover .service-image {
        ...
        @media (max-width: 768px) {
        .rts-section-gap {
        padding-top: 80px !important; /* updated Isse upar wale section se 100px ka gap aa jayega */
    }
          .bg-title.watermark-service { 
            font-size: 80px !important; 
            top: 0% !important; 
